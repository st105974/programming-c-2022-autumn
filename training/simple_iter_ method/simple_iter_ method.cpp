...
public:
	...
	{
		Matrix x_1(a.size(), 1);
		x_1 = (*this)(0, a.size() - 1, 0, a[0].size() - 2) * x_0 + (*this)(0, a.size() - 1, a[0].size() - 1, a[0].size() - 1);
		Matrix x_res(a.size(), 1);
		x_res = x_1 - x_0;
		double x_res1 = x_res.MatrixNorm();
		double norm_h = (*this)(0, a.size() - 1, 0, a[0].size() - 2).MatrixNorm();
		double r = norm_h / (1 - norm_h) * x_res1;
		if (r < prec)
		{
			return x_1;
		}
		...
		{
			return simple_iter_method(x_1, prec);
		}
	}
